...
class InstallData implements Setup\InstallDataInterface {
	...
	public function install(Setup\ModuleDataSetupInterface $setup, Setup\ModuleContextInterface $moduleContext) {
		$pdftemplateData['name'] = 'Demo PDF Invoice Template';
		...
		$pdftemplateData['template_data']['margin'] = '10,15,15,10';
		...
		$pdftemplateData['template_data']['body'] = '<table style="border-collapse: collapse; border-spacing: 0; margin: 0 auto; width: 100%; font-family: \'Trebuchet MS\'; max-width: 1280px; border: none;" border="0" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="padding: 25px 0 35px; background: #ef9a6b;"><table style="border-collapse: collapse; margin: 0px auto; width: 100%;" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding: 0 0 0 25px; text-align: left; vertical-align: top; width: 25%;" align="left"><h3 style="color: #2b2b2b; margin: 0 0; font-size: 18px;">Address 1</h3><p style="margin: 10px 0 0; font-size: 16px; color: #000;"><span>{{config path="general/store_information/name"}}</span></p><p style="margin: 10px 0 0; font-size: 16px; color: #000;">{{config path="general/store_information/street_line1"}},</p><p style="margin: 10px 0 0; font-size: 16px; color: #000;">{{config path="general/store_information/street_line2"}},</p><p style="margin: 10px 0 0; font-size: 16px; color: #000;">{{config path="general/store_information/region_id"}},</p><p style="margin: 10px 0 0; font-size: 16px; color: #000;">{{config path="general/store_information/country_id"}},</p><p style="margin: 10px 0 0; font-size: 16px; color: #000;">{{config path="general/store_information/postcode"}}</p></td><td style="padding: 0 0 0 25px; text-align: left; vertical-align: top; width: 25%;" align="left"><h3 style="color: #2b2b2b; margin: 0 0; font-size: 18px;">Phone</h3><p style="margin: 10px 0 0; font-size: 16px; color: #000;">{{var mageants_pdfinvoice/business_contact/phone}}<br /> {{config path="general/store_information/phone"}}<br /> {{var mageants_pdfinvoice/business_contact/Fax}}</p></td><td style="padding: 0 0 0 25px; text-align: left; vertical-align: top; width: 25%;" align="left"><h3 style="color: #2b2b2b; margin: 0 0; font-size: 18px;">Email</h3><p style="margin: 10px 0 0; font-size: 16px; color: #000;">{{var mageants_pdfinvoice/business_contact/email}}<br /><br /></p></td><td style="padding: 0 10px 0 25px; text-align: right; vertical-align: middle; width: 25%;" align="left"><img src="{{var mageants_pdfinvoice/business_info/company_logo}}" alt="logo" /></td></tr></tbody></table></td></tr><tr><td style="padding: 20px 10px 3px 45px; background: #1b404e;"><table style="border-collapse: collapse; margin: 0px auto; width: 100%;" cellspacing="0" cellpadding="0"><tbody><tr><td style="padding: 0 0; text-align: left; vertical-align: middle; width: 50%;" align="left"><h1 style="color: #fff; margin: 0 0; font-size: 38px;">INVOICE</h1></td><td style="padding: 0 0; text-align: right; vertical-align: middle; width: 50%;" align="right"><p style="margin: 0 0; font-size: 16px; color: #fff; width: 234px; float: right; text-align: left;">Invoice: <strong>#{{var invoice.increment_id}}</strong><br /> Invoice: <strong> {{var invoice.created_at}}</strong><br /> Invoice Amount: <strong> {{var invoice.grand_total }} </strong></p></td></tr></tbody></table></td></tr><tr><td style="padding: 30px 45px 3px 45px;"><table style="border-collapse: collapse; margin: 0px auto; width: 100%;" cellspacing="0" cellpadding="0"><tbody><tr><td valign="top"><h2 style="font-size: 24px; color: #433d41; font-weight: bold; margin: 0 0 20px;">BILLING ADDRESS</h2><p style="font-size: 16px; color: #433d41; font-weight: bold; margin: 0 0 20px;">{{var formattedBillingAddress|raw}}</p></td><td style="padding-left: 10px; text-align: right;" valign="top"><h2 style="font-size: 24px; color: #433d41; font-weight: bold; margin: 5px 0 0;">PAYMENT METHOD</h2><p style="color: #433d41; font-size: 16px; line-height: 1.2; margin-top: 0; padding: 0;">{{var payment_html}}</p></td></tr></tbody></table></td></tr><tr><td style="padding: 30px 45px 3px 45px;">{{layout area="frontend" handle="sales_email_order_invoice_items" invoice=$invoice order=$order}}</td></tr><tr><td style="padding: 15px 45px 15px;"><table style="border-collapse: collapse; margin: 0px auto; width: 100%;" cellspacing="0" cellpadding="0"><tbody><tr><td style="text-align: left; font-size: 16px; width: 100%;" align="left"><strong style="font-size: 18px;">Note</strong><br /> {{var comment}}</td></tr></tbody></table></td></tr></tbody></table>';
